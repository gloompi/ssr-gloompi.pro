"""
Django settings for gloompi project.
...
WSGI_APPLICATION = 'gloompi.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gloompi_db',
        'USER' : os.environ['PQ_USER'],
        'PASSWORD' : os.environ['PQ_PASSWORD'],
        'HOST' : '127.0.0.1',
        'PORT' : '5432',
    }
    # 'default': {
